        ...
        for (ProductEntity product : list) {
            ...
            if(i < 10){
                ...
                if(productRespone.getRomRespones() != null && productRespone.getRomRespones().size() > 0){
                    if(productRespone.getRomRespones().get(0).getProductDetailStatusRespones() != null && productRespone.getRomRespones().get(0).getProductDetailStatusRespones().get(0).getPriceString() != null){
    ...
    public ProductRespone findById(Long id) {
        ...
        if (productEntity.isPresent()) {
            ...
            for (int i = 0; i < respone.getRomRespones().size(); i++) {
                if(respone.getRomRespones().get(i).getProductDetailStatusRespones().size() == 0){
